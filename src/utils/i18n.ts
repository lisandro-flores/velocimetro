...
const es: Dictionary = {
  ...
  'settings.layout.sport': '🏎️ Deportivo',
  'settings.layout.minimalist': '🧘 Minimalista',
  'settings.layout.touring': '🗺️ Turismo',
  'settings.engine.title': 'Motor (Cilindros)',
  'settings.engine.desc': 'Ajuste del Tacómetro Sónico',
  'settings.maxRpm.title': 'Escala Máxima de RPM',
  'settings.maxRpm.desc': 'Línea roja del tacómetro según tu moto',
...
const en: Dictionary = {
  ...
  'settings.layout.sport': '🏎️ Sport',
  'settings.layout.minimalist': '🧘 Minimalist',
  'settings.layout.touring': '🗺️ Touring',
  'settings.engine.title': 'Engine (Cylinders)',
  'settings.engine.desc': 'Sonic Tachometer Setting',
  'settings.maxRpm.title': 'Maximum RPM Scale',
  'settings.maxRpm.desc': 'Tachometer redline for your bike',
