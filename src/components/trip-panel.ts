...
export class TripPanelComponent {
  ...
  update(data: TripData): void {
    ...
    const stateLabels = { idle: 'Detenido', running: 'En marcha', paused: 'Pausado' };
    ...
    this.startBtn.innerHTML = data.state === 'paused'
      ? '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="5 3 19 12 5 21 5 3"/></svg> Reanudar'
      : '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="5 3 19 12 5 21 5 3"/></svg> Iniciar Viaje';
  }
  ...
  private render(): void {
    this.container.innerHTML = `
      <div class="trip-panel" id="trip-view">
        ...
        <div class="trip-status status-idle" id="trip-status">Detenido</div>
        ...
        <div class="trip-grid">
          <div class="trip-card">
            ...
            <div class="trip-card-label">Distancia</div>
          </div>
          <div class="trip-card">
            ...
            <div class="trip-card-label">Tiempo</div>
          </div>
          <div class="trip-card">
            ...
            <div class="trip-card-label">Vel. Promedio</div>
          </div>
          <div class="trip-card">
            ...
            <div class="trip-card-label">Vel. Máxima</div>
          </div>
          <div class="trip-card trip-card-wide">
            ...
            <div class="trip-card-label">Altitud</div>
          </div>
        </div>

        <div class="trip-controls">
          <button class="btn btn-primary" id="trip-start-btn"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="5 3 19 12 5 21 5 3"/></svg> Iniciar Viaje</button>
          <button class="btn btn-warning" id="trip-pause-btn" style="display:none"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="6" y="4" width="4" height="16"/><rect x="14" y="4" width="4" height="16"/></svg> Pausar</button>
          <button class="btn btn-danger" id="trip-reset-btn" style="display:none"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"/><path d="M3 3v5h5"/></svg> Reset</button>
